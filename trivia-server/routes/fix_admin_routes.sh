...
# 1) Go to your server code
cd ~/rsn8tv-trivia/trivia-server

# 2) Backup the old routes file
cp routes/adminRoutes.js{,.bak}

# 3) Overwrite with the corrected file
...
# 4) Done
echo "✅ routes/adminRoutes.js has been replaced with the corrected version."
echo "✅ Backup saved as routes/adminRoutes.js.bak"
echo "Restart your server: pm2 restart rsn8tv"
